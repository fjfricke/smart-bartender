...
(function($) {
    $.fn.keyboard = function(options) {
        ...
        var settings = $.extend({
            ...
            btnClasses: 'btn btn-default no-uppercase black',
                ...
                content: function() {
                    ...
                    $.each(settings.layout, function() {
                        ...
                        $.each(line, function() {
                            ...
                            switch (this[0]) {
                                case 'shift':
                                    btn.addClass('jqbtk-shift').html('<i class="material-icons">keyboard_arrow_up</i>');
                                    break;
                                case 'space':
                                ...
                                case 'del':
                                    ...
                                    btn.addClass('jqbtk-del').html('<i class="material-icons">keyboard_arrow_left</i>');
                                    break;
                                case 'enter':
